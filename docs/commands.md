# Commands Reference (auto-generated — v0.2.4)
...
```jsonc
// Success (stdout)
{ "status": "success", "meta": { "command": "abap pull", "version": "0.2.4", "timestamp": "...", "durationMs": 42, "warnings": [] }, "data": { ... } }
...
| Argument | Description |
|----------|-------------|
| `<type>` | Object type — enum: `CLAS`, `INTF`, `PROG`, `FUGR`, `TABL`, `STRU`, `DOMA`, `DTEL`, `HTTP`, `TRAN`, `TTYP`, `MSAG`, `DDLS` |
| `<name>` | Object name |
